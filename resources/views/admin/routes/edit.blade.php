        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="px-6 py-4">
                <div class="flex justify-between items-center mb-4">
                    <h1 class="text-2xl font-bold">Edit Route</h1>
                ...
                <form action="{{ route('admin.routes.update', $route) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="from" id="from" value="{{ old('from', $route->from) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            @error('from')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="to" id="to" value="{{ old('to', $route->to) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            @error('to')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="time" name="departure_time" id="departure_time" 
                                value="{{ old('departure_time', date('H:i', strtotime($route->departure_time))) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <input type="time" name="arrival_time" id="arrival_time" 
                                value="{{ old('arrival_time', date('H:i', strtotime($route->arrival_time))) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    ...
                    <div>
                        ...
                        <input type="number" name="fare" id="fare" value="{{ old('fare', $route->fare) }}" step="0.01" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        @error('fare')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
...
// Run validation on page load for edit form
validateArrivalTime();
</script>
